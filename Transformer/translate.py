...
def translate(opt, model, SRC, TRG, references):
    ...
    while True:
        ...
        if opt.text=='f':
            ...
            try:
                ...
                continue
        phrase = translate(opt, model, SRC, TRG,references)
        #ppl = scorer.get_perplexity(phrase)
        print('> '+ phrase + '\n')
        ##print(ppl)

        #candidate = phrase.split()
        #references = [ref.split() for ref in references]
        bleu_score = sentence_bleu(references, phrase)
